...
public partial class Sales_UserList : BasePage
{
    #region Properties
    ...
    protected void FillgvUserList()
    {
        ...
        {
            gvUserList.Rows[0].Visible = false;
        }
    }
    protected void gvUserList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (lblSerialNo != null)
            {
                int serialNo = gvUserList.PageIndex * gvUserList.PageSize + int.Parse(e.Row.RowIndex.ToString());
